...
abstract:  |
  ...
  According to Bayesian, “inverse optics” accounts, perceiving is inferring the most likely state of the world given noisy sensory data. This inference critically depends on an internal model specifying how world states translate to visual sensations. Alternative accounts explain perceptual decisions as a rule-based process, with no role for beliefs about perception itself. Here, we contrast the two options, focusing on decisions about perceptual absence as a critical test case. Three near-threshold visual detection experiments under partial stimulus occlusion reveal strikingly different effects of sensory noise and occlusion on decisions about presence and absence. Our normative model accounts for these asymmetries by postulating dissociable roles for stimulus visibility and beliefs about visibility, and further explains reliably opposite effects of occlusion on target-absent decisions across participants as reflecting the differential incorporation of beliefs about visibility into perceptual decisions. We discuss implications of our inverse-optics formulation for inference and perception more broadly.
