function [] = simulateAndSaveVT(parameters,dt,T,ntrials,filename)
...
for i=1:nsubjects
    ...
    if ~isnan(parameters_i(1))
        subj_simulated_data = simulate_data_by_occlusion_vt_csv(parameters_i, dt, T, ntrials);
