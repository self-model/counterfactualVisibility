...
E2_best_parameters(:,3:4) = E2_best_parameters(:,1:2);
E2_best_parameters(:,9) = E2_best_parameters(:,8);
...
writetable(E2_simulated_data,'simulated_E2a_ttA.csv','Delimiter',',')
...
E3_best_parameters(:,3:4) = E3_best_parameters(:,1:2);
E3_best_parameters(:,9) = E3_best_parameters(:,8);
...
writetable(E3_simulated_data,'simulated_E3a_ttA.csv','Delimiter',',')
