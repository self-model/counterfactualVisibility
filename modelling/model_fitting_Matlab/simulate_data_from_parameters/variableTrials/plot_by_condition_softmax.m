function plot_by_condition_softmax(params, data, dt, T)
    ...
    % multiply the softmax parameter by 10
    params(9) = 10*params(9);
    
    %apply the exponent to alpha and softmax temp
    params(7:9) =exp(params(7:9));


    % HIGH OCCLUSION
    predictions_high = get_model_predictions_softmax([params(1), params(2)+params(1)]*params(7), [params(3), params(4)+params(3)]*params(8), params(5), params(6), params(9),dt, T);
    figure;
    ...
    % LOW OCCLUSION
    predictions_low = get_model_predictions_softmax([params(1), params(2)+params(1)]/params(7), [params(3), params(4)+params(3)]/params(8), params(5), params(6), params(9), dt, T);
